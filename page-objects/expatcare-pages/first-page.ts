...
export class ExpatcarePage {
   ...
   // readonly lessCharUsernameErrorMsg:Locator;
    ...
    constructor(page: Page) {
        ...
        this.selectcountryInputField = page.locator("//span[normalize-space()='Germany']");
      ...
      //this.codeDropdownField = page.locator("//mat-icon[@class='mat-icon notranslate material-icons mat-ligature-font mat-icon-no-color ng-tns-c19-7']");
        ...
        this.selectmobilecodeInputField = page.locator("//mat-icon[@class='mat-icon notranslate material-icons mat-ligature-font mat-icon-no-color ng-tns-c19-7']");
       ...
       // this.firsttabnextButton = page.locator("//button[.//span[normalize-space()='Next']]");
       ...
       // this.thirdtabnextButton = page.locator("//mat-icon[@aria-label='Mat Arrow Forward']");
        ...
        this.directdebitButton = page.locator("//input[@id='mat-radio-9-input']");               
        this.creditcardButton = page.locator("//input[@id='mat-radio-9-input']");   
       ...
       this.codeDropdownFieldForBTPolicy = page.locator("//mat-label[text()='Code']").first();
        //this.codeDropdownFieldForBTPolicy = page.locator("//span[contains(text(),'Code')]");
    ...
    async expatcareFirstTab(firstname: string, lastname: string, passport: string, code: string, mobilenumber: string, email: string, streetname: string, streetnumber: string, postalcode: string, address: string, city: string, day: string, month: string, year: string) {
       // await this.expatcarebButton.click();
        ...
        //await this.selectmobilecodeInputField.click();
    ...
    async verifyAplicationFirstTabText(expectedAdditinalinsuredpersonText: string) {
        await this.page.waitForLoadState('networkidle');
        const actualAdditinalinsuredpersonText = await this.page.locator("//h1[normalize-space()='Application for MAWISTA Expatcare']").textContent();
   ...
   async verifyinvalidpostalcodeerrorText(expectedinvalidpostalcodefirsttabText: string) {
    ...
    async verifystreetnameerrortextFirstTabText(expectedAdditinalinsuredpersonText: string) {
        await this.page.waitForLoadState('networkidle');
        const actualAdditinalinsuredpersonText = await this.page.locator("//p[@class='form-error ng-star-inserted']").textContent();
        expect(actualAdditinalinsuredpersonText).toBe(expectedAdditinalinsuredpersonText);
    }
    ...
    async clickOnComforttileofeightynineThirdTab() {
        await this.page.locator("//label[@for='mat-radio-9-input']").click();
        await this.page.waitForLoadState('networkidle');
        await this.page.waitForTimeout(10000);
    }
    ...
    async verifyPremiumvaluesforExpatcareExcludinguptofourtyyrs(expectedclassicText: string,expectedcomfortText: string,expectedpremiumText: string) {
        await this.page.waitForLoadState('networkidle');
       const actualclassicText = await this.page.locator("//b[normalize-space()='75']").textContent();
        expect(actualclassicText).toContain(expectedclassicText);
        const actualcomfortText = await this.page.locator("//b[normalize-space()='95']").textContent();
        expect(actualcomfortText).toContain(expectedcomfortText);
        const actualpremiumText = await this.page.locator("//b[normalize-space()='150']").textContent();
    ...
    //     await this.page.waitForLoadState('networkidle');
    //    // const actualfirtliText =  await (await this.page.waitForSelector("//div[@id='row-12889']//h2[contains(text(),'Thank you')]")).textContent();
    //   //   const actualfirtliText = await this.page.locator("//div[@id='row-12889']//h3[contains(text(),'Thank you')]").textContent();
    //      const actualfirtliText = await this.page.locator("(//h2[contains(text(),'Thank you')])[1]").textContent();
...
async verifyThankyoupageText(expectedthankyouText: string){
    await this.page.waitForLoadState('networkidle');    
...
// await this.page.pause();
    ...
    async ClickonincludeciverageforUSAandCandaThirdtTab() {
        ...
        await this.page.locator("//input[@id='mat-mdc-checkbox-9-input']").click();
        await this.page.waitForLoadState('networkidle');
        await this.page.waitForTimeout(10000);
    }
    ...
    async verifyPremiumvaluesforExpatcareIncludinguptofourtyyrs(expectedclassicText: string,expectedcomfortText: string,expectedpremiumText: string) {
        await this.page.waitForLoadState('networkidle');
       const actualclassicText = await this.page.locator("//b[normalize-space()='175']").textContent();
        expect(actualclassicText).toContain(expectedclassicText);
        const actualcomfortText = await this.page.locator("//b[normalize-space()='250']").textContent();
        expect(actualcomfortText).toContain(expectedcomfortText);
        const actualpremiumText = await this.page.locator("//b[normalize-space()='450']").textContent();
        expect(actualpremiumText).toContain(expectedpremiumText);
    }
    ...
    async verifyPremiumvaluesforExpatcareExcludinguptofourtytofiftyfiveyrs(expectedclassicText: string,expectedcomfortText: string,expectedpremiumText: string) {
        await this.page.waitForLoadState('networkidle');
       const actualclassicText = await this.page.locator("//b[normalize-space()='85']").textContent();
        expect(actualclassicText).toContain(expectedclassicText);
        const actualcomfortText = await this.page.locator("//b[normalize-space()='115']").textContent();
        expect(actualcomfortText).toContain(expectedcomfortText);
        const actualpremiumText = await this.page.locator("//b[normalize-space()='170']").textContent();
        expect(actualpremiumText).toContain(expectedpremiumText);
    }
    ...
    async verifyPremiumvaluesforExpatcareIncludinguptofourtytofiftyfiveyrs(expectedclassicText: string,expectedcomfortText: string,expectedpremiumText: string) {
        await this.page.waitForLoadState('networkidle');
       const actualclassicText = await this.page.locator("//b[normalize-space()='250']").textContent();
        expect(actualclassicText).toContain(expectedclassicText);
        const actualcomfortText = await this.page.locator("//b[normalize-space()='350']").textContent();
        expect(actualcomfortText).toContain(expectedcomfortText);
        const actualpremiumText = await this.page.locator("//b[normalize-space()='450']").textContent();
        expect(actualpremiumText).toContain(expectedpremiumText);
    }
    ...
    async verifyPremiumvaluesforExpatcareExcludinguptofiftysixtosixtyyrs(expectedclassicText: string,expectedcomfortText: string,expectedpremiumText: string) {
       ...
       const actualclassicText = await this.page.locator("//b[normalize-space()='250']").textContent();
        ...
        const actualcomfortText = await this.page.locator("//b[normalize-space()='350']").textContent();
        expect(actualcomfortText).toContain(expectedcomfortText);
        const actualpremiumText = await this.page.locator("//b[normalize-space()='400']").textContent();
        expect(actualpremiumText).toContain(expectedpremiumText);
    }
    ...
    async verifyPremiumvaluesforExpatcareIncludinguptofiftysixtosixtyyrs(expectedclassicText: string,expectedcomfortText: string,expectedpremiumText: string) {
        await this.page.waitForLoadState('networkidle');
       const actualclassicText = await this.page.locator("//b[normalize-space()='700']").textContent();
        expect(actualclassicText).toContain(expectedclassicText);
        const actualcomfortText = await this.page.locator("//b[normalize-space()='850']").textContent();
        expect(actualcomfortText).toContain(expectedcomfortText);
        const actualpremiumText = await this.page.locator("//b[normalize-space()='1000']").textContent();
        expect(actualpremiumText).toContain(expectedpremiumText);
    }
    ...
    async verifyPremiumvaluesforExpatcarecomfort(expectedclassicText: string) {
        await this.page.waitForLoadState('networkidle');
       const actualclassicText = await this.page.locator("//b[normalize-space()='95']").textContent();
        expect(actualclassicText).toContain(expectedclassicText);
    ...
    async verifyPremiumvaluesforExpatcareprepium(expectedclassicText: string) {
        await this.page.waitForLoadState('networkidle');
       const actualclassicText = await this.page.locator("//b[normalize-space()='150']").textContent();
        expect(actualclassicText).toContain(expectedclassicText);
    ...
    async verifyclasaluesforExpatcareprepium(expectedclassicText: string) {
        await this.page.waitForLoadState('networkidle');
       const actualclassicText = await this.page.locator("//b[normalize-space()='160']").textContent();
        expect(actualclassicText).toContain(expectedclassicText);
   ...
   // async verifydebitcarddettailstab(expectednameText: string,expectedibanText: string) {
    ...
    async clickOnPremiumTile() {
        await this.page.locator("//label[@for='mat-radio-10-input']").click();
        await this.page.waitForLoadState('networkidle');
        await this.page.waitForTimeout(10000);
    }
    ...
    async enterpolicydetails(policyid : string) {
        ...
        await this.page.waitForLoadState('networkidle');
        await this.page.locator("//div[contains(@class,'row showHideDiv')]//div[3]//div[3]//a[1]//i[1]").click();
        await this.page.waitForTimeout(10000);
    ...
    async verifyPolicystatustext(expectedpolicystatusText: string) {
       ...
       async verifyNewPolicystatusrejecttext(policyid: string,expectedpolicystatusText : string) {
        const actualpolicystatuscText  = await this.page.locator("//div[@class='row showHideDiv']//div[3]//div[1]//div[1]//div[2]//span[1]//i[1]//b[1]").textContent();
        expect(actualpolicystatuscText).toContain(expectedpolicystatusText);
       /* const policystatuscText  = await this.page.locator("//b[normalize-space()='Open for Renewal']").textContent();
        if(policystatuscText== "Open for Renewal")
          {
 ...
 /*   async enterLoginDetails(username: string,  password: string) {
    ...
    async expatcareFirstTabBTPolicy(firstname: string, lastname: string, passport: string, code: string, mobilenumber: string, email: string, streetname: string, streetnumber: string, postalcode: string, address: string, city: string, day: string, month: string, year: string) {
       // await this.expatcarebButton.click();
        await this.firstnameInputField.fill(firstname);
        await this.lastnameInputField.fill(lastname);
        await this.homecountryDropdownField.click();
    ...
    async clickOnBankTransferradioButton() {
        await this.bankTransfercardButton.click();
        await this.page.waitForLoadState('networkidle');
       // await this.page.waitForTimeout(10000);
    }
